...
def check_perceptron():
    ...
    if check_tuple(
        ...
        return
    #
    # feature_matrix = np.array([[-0.25402486, 0.31641348, -0.16375944,  0.32376378,  0.06663895, -0.48110164, -0.09118709, 0.11374904, -0.3939721, -0.07742866],
    #     [-0.11163107, -0.06171663, -0.15944013, -0.35002203, -0.34425033, 0.17520317, -0.47922497, -0.37251589, -0.47844418, 0.41816658],
    #     [0.42818949, -0.42244175, -0.04867489, -0.10724956, 0.46922473, 0.25129665, -0.35528028, 0.36792551, -0.41840585, 0.15456018],
    #     [-0.27500774, -0.48552094, 0.29176527, 0.06214019, 0.11125789, 0.06312413, -0.12481328, -0.17321552, 0.2751544, -0.1947479],
    #     [0.04711179, 0.33870575, -0.37036374, -0.174152, 0.27563537, -0.14602375, 0.4054421, 0.49552613, -0.05116463, 0.15383939]])
    # labels = np.array([-1, 1, 1, -1, 1])
    # T = 5
    # exp_res = (np.array([0.4645133, 0.4460966, -0.6578097, -0.9100780, -0.2465118, 0.4471569, 0.1422175, 0.1824767, -0.4107911, 0.8441825]), 2)
    # if check_tuple(
    #         ex_name, p1.perceptron,
    #         exp_res, feature_matrix, labels, T):
    #     return
